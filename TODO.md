...
| **B** | Auf Schwellenabsenkung umbauen, wie bei der Unverwundbarkeit (`Math.Min(normal, eigener Wert)`) | Heilung käme später, aber nie gar nicht. Setzt voraus, dass eine Barriere den Heilbedarf senkt — sie tut es nicht, sie verschiebt ihn. Der Fehler wäre milder, nicht behoben | N, R |
| **C** | Nur für die Notfallfrage anrechnen („überlebt er den nächsten Treffer") | Das ist die einzige Frage, für die effektive HP die richtige Größe sind. Im Baum gibt es diese Trennung nicht — sie wäre erst zu bauen, als neue Regel ohne Nachweis | N, R |
