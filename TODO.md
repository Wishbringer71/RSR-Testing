...
### Walking Dead: nur leicht unterstützen, solange er sich selbst heilt · N

**Vorgabe des Auftraggebers (25.09.2026), vollständig in Konzept 09:** Unter Walking Dead heilt sich der Dunkelritter durch Angriffe selbst und fällt nicht unter 1 HP; er stirbt erst, wenn beim Ablauf keine Heilung in Höhe seiner Maximalgesundheit zusammengekommen ist. Am Anfang wird ihm vertraut und nur leicht mit einem HoT geholfen. Voll unterstützt wird erst, wenn der Timer ausläuft oder klar ist, dass er es in der Restzeit nicht schafft — etwa ohne Gegner oder vor einem Ereignis, in dem er nicht angreifen kann.

**Heute im Code dagegen:** Benediction zündet unter 30 % sofort, also bei 1 HP am Anfang; das Regen des Weißmagiers ist unter `RegenHeal` gesperrt.

**Entwurf (A146), noch nicht gebaut:** Erkennung `WalkingDeadCarriedBySelfHeal` — trägt, solange der Timer nicht im Vorlauf der Living-Dead-Sperre ist, ein Gegner in Reichweite seiner Waffenfertigkeit steht (Spielreichweite von Hard Slash), keine BossMod-Auszeit vor Ablauf angekündigt ist **und der gemessene Kurs trägt**: Netto-Gesundheitsanstieg seit dem letzten Tiefpunkt aus `RecordedHP`, hochgerechnet auf die Restzeit, erreicht die volle Gesundheit. Netto unterschätzt die kumulierte Heilung (Schaden zieht ab), die Freigabe kommt also eher zu früh als zu spät. Verbraucher: Heilziel-Eingang lässt den Träger nur für Aktionen zu, die einen HoT aus `SingleHots` verleihen; Regen-Sperre des Weißmagiers ausgenommen. Anzeige im Diagnosefenster. Stand der Erkennung: Entwurf im Sitzungsverzeichnis, nicht im Zweig.
