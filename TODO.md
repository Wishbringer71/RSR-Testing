...
**Die Verlangsamung durch Dritte bleibt unabgedeckt.** Gemeint ist nicht der Abtausch des Dunkelritters — der ist jetzt gesperrt —, sondern jede Verlangsamung aus anderer Hand. `StatusHelper.SlowStatus` hat im ganzen Baum einen einzigen Leser, `PackSlowed` in der Dunkelritter-Rotation, und der misst vor der Zündung, nicht danach. Ohne eine zweite Rotation, die dieselbe Regel kennt, ist das von hier aus nicht zu schließen.
