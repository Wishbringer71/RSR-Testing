...
**Was die Bereinigung nicht erreicht, ausdruecklich benannt:** GitHub haelt die Commits eines Pull Requests unabhaengig von der Zweighistorie vor, `a63a5aa07` bleibt also ueber `pull/8/commits` erreichbar; das kann nur der GitHub-Support entfernen. Ebenso wenig erreicht sie bereits gezogene Klone und Forks. Die wirksame Vorbeugung liegt ausserdem bei ihm: die Profileinstellungen „Keep my email addresses private" und „Block command line pushes that expose my email" haetten die Pushes abgelehnt.
